...
public class EdgeCensor extends BaseCensor {
	private static final LoggerService logger = new LoggerService(LoggerFactory.getLogger(EdgeCensor.class));
	...
	public void censor(FieldSet fields, UUID userId) throws MyForbiddenException {
		...
		this.authService.authorizeForce(Permission.BrowseEdge, Permission.DeferredAffiliation);
		FieldSet edgeAccessesFields = fields.extractPrefixed(this.asIndexerPrefix(Edge._edgeAccesses));
