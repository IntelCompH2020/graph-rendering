...
public class EdgeDataCensor extends BaseCensor {
	private static final LoggerService logger = new LoggerService(LoggerFactory.getLogger(EdgeDataCensor.class));
	private final AuthorizationService authService;
	private final CensorFactory censorFactory;

	@Autowired
	public EdgeDataCensor(
	...
	public void censor(FieldSet fields, UUID userId) throws MyForbiddenException {
		...
		this.authService.authorizeForce(Permission.BrowseEdgeData, Permission.DeferredAffiliation);
	}
