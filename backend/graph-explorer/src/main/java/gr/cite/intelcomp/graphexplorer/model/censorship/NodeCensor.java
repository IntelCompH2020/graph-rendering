...
public class NodeCensor extends BaseCensor {
	private static final LoggerService logger = new LoggerService(LoggerFactory.getLogger(NodeCensor.class));
	...
	public void censor(FieldSet fields, UUID userId) throws MyForbiddenException {
		...
		this.authService.authorizeForce(Permission.BrowseNode, Permission.DeferredAffiliation);
		FieldSet nodeAccessesFields = fields.extractPrefixed(this.asIndexerPrefix(Node._nodeAccesses));
