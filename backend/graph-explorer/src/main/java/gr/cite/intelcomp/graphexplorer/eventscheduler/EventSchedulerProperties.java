package gr.cite.intelcomp.graphexplorer.eventscheduler;
	...
	public static class Task {
		...
		public static class Processor {
			...
			public static class Options {
				...
				private final Long parallelTasksThreshold;
				...
				public Options(Long retryThreshold, Long maxRetryDelaySeconds, Long tooOldToHandleSeconds, Long parallelTasksThreshold) {
					...
					this.parallelTasksThreshold = parallelTasksThreshold;
				}
				...
				public Long getParallelTasksThreshold() {
					return parallelTasksThreshold;
				}
			}
		}
	}
