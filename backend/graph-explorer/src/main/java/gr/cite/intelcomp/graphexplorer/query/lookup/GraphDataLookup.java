...
public class GraphDataLookup extends GremlinLookup {
    ...
    public gr.cite.intelcomp.graphexplorer.elastic.query.NodeDataQuery enrichElastic(QueryFactory queryFactory) {
        gr.cite.intelcomp.graphexplorer.elastic.query.NodeDataQuery query = queryFactory.query(gr.cite.intelcomp.graphexplorer.elastic.query.NodeDataQuery.class);
        if (this.like != null) query.like(this.like);
        if (this.ids != null) query.ids(this.ids);
        if (this.excludedIds != null) query.excludedIds(this.excludedIds);
        if (this.x != null) query.x(this.x);
